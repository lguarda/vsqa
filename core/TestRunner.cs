...
{
    public static async Task<List<(string Name, bool Passed, List<string> Logs)>> RunAll(ICoreServerAPI sapi, IServerNetworkChannel channel)
    {
        ...
        foreach (var type in testTypes)
        {
            ...
            var ctx = new TestContext(sapi, channel);
            bool passed = true;
